...
// { severity: 'info'|'warn'|'danger', title, body }。
//
// 与原 public/app/recommendations.js 逐字等价，唯一改动：把散落在文案里的阈值
// （如 riskScore>=25、延迟>400、丢包>2、TLS>700）改成从 config 读取，
// 使校准改阈值时建议触发条件与文案数字同步变化，不再出现"打分用A、文案说B"。
